...
class TvShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv_show" do
    assert_difference('TvShow.count') do
      post tv_shows_url, params: { tv_show: { first_air_date: @tv_show.first_air_date, last_air_date: @tv_show.last_air_date, name: @tv_show.name, number_of_episodes: @tv_show.number_of_episodes, number_of_seasons: @tv_show.number_of_seasons, overview: @tv_show.overview, show_poster_path: @tv_show.show_poster_path, tmdb_show_id: @tv_show.tmdb_show_id } }
    end
